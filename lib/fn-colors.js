...
function addProperty(color, func) {
  ...
  var colorizer = function () {
    // Closure the original function
    var fn = this;

    // Define an return the colorized function
    return function colorizedFn () {
      ...
      return fn.apply(this, coloredArgs);
    };
  };

  // Add the colorizer to the prototype
  ...
  // DEV: Technically, this is not necessary but if we ever add browser support like colors
    fnProto.__defineGetter__(color, colorizer);
  }
}
